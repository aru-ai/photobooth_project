      ...
      <q-card class="photobooth-main-card">
        ...
        >
          ...
          <div class="gallery-sidebar">
            ...
            <div v-if="recordedVideos.length" class="column q-gutter-sm">
              <q-img
                v-for="(video, index) in recordedVideos"
                :key="index"
                :src="video.thumbnail"
                class="gallery-thumb"
...
export default defineComponent({
  ...
  setup() {
    ...
    const previewVideo = ref<RecordedVideo | null>(null);
    ...
    function toggleRecording() {
      ...
      if (!isRecording.value) {
        // Fake video capture for demo - replace with real API
        const id = Math.floor(Math.random() * 5000);
        const video: RecordedVideo = {
          url: 'https://www.w3schools.com/html/mov_bbb.mp4',
          thumbnail: `https://picsum.photos/seed/video${id}/600/600`,
        };
        recordedVideos.value.unshift(video);
      }
    }

    function openPreview(video: RecordedVideo) {
